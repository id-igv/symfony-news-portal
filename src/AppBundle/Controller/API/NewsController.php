...
class NewsController extends Controller
{
	...
	if (!$this->get('security.authorization_checker')->isGranted('ROLE_AUTHOR')) {
		...
		$imagePath = '';
		$servUploader = $this->get('app.uploader');
		$servUploader->setTargetDir($this->getParameter('news_av_dir'));
		if (false !== ($imagePath = $servUploader->uploadFromUrl($_news->titleImage, "news_title_image_id".$news->getId()))) {
